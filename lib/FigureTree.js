...
figure.FigureTree.prototype.push = function(figure) {
  ...
  if (figure) {
    if (child = this.get(figure.directory)) {
      ...
      figure.index = this.tree.length > 0 ? this.tree.length -1 : 0;
...
figure.FigureTree.prototype.directories = function() {
  var directories = []

  this.tree.forEach(function(figure){
    directories.push(figure.directory);
  });
