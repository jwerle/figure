...
Figure.isFigure = Figure.prototype.isFigure = Figure.check = Figure.prototype.check = function(directory) {
...
generateIndexFileData = function(directory) {
  return  [
    "module.exports = require('auto-loader').load(__dirname)['"+ path.basename(directory) +"']"
  ].join('\n')
};
